...
class carRescueController extends CI_Controller{

	public function __construct(){
		parent::__construct();
		$this->load->helper('url');
		$this->load->model('carRescueModel');
	}

	public function showCarRescue(){
		$data["getData"] = $this->carRescueModel->get_CarRescue();
		$this->load->view("carRescueIndex",$data);
	}

	public function showBodyDetail($bodyID){
		$data["getDataByID"] = $this->carRescueModel->get_Data_by_ID($bodyID);
