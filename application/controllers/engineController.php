...
class engineController extends CI_Controller{

	public function __construct(){
		parent::__construct();
		$this->load->helper('url');
		$this->load->model('engineModel');
	}

	public function showEngine(){
		$data["getData"] = $this->engineModel->get_Engine();
		$this->load->view("engineIndex",$data);
	}

	public function showBodyDetail($bodyID){
		$data["getDataByID"] = $this->engineModel->get_Data_by_ID($bodyID);
