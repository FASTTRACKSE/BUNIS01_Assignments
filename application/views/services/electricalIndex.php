...
<header class="header" id="header3">
    <div class="left">
        <div class="caption animated bounceInLeft">
            <h2 class="title display-3">Electrical</h2>
...
<div class="title-arch">Electrical<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas pulvinar ex pulvinar est laoreet ullamcorper.</p></div>
...
<?php foreach ($getData as $data) { ?>
      <div class="services-item slide">
          <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10 project wow animated animated4 fadeInLeft">
              ...
              <h2><?php echo $data['electricalName']; ?></h2>
              <hr />
              <p><?php echo $data['electricalDesc']; ?></p>
